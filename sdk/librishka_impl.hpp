...
enum rishka_syscall {
    ...
    RISHKA_SC_NVS_HAS_WIFI_CONFIG,
    RISHKA_SC_NVS_SET_WIFI_SSID,
    RISHKA_SC_NVS_SET_WIFI_PWORD,

    RISHKA_SC_WIFI_CONNECT,
    RISHKA_SC_WIFI_RECONNECT,
    RISHKA_SC_WIFI_SET_DNS,
    RISHKA_SC_WIFI_BANDWIDTH,
    RISHKA_SC_WIFI_DISCONNECT_ASYNC,
    RISHKA_SC_WIFI_DISCONNECT,
    RISHKA_SC_WIFI_ERASE_AP,
    RISHKA_SC_WIFI_IS_CONNECTED,
    RISHKA_SC_WIFI_SET_AUTO_RECONNECT,
    RISHKA_SC_WIFI_GET_AUTO_RECONNECT,
    RISHKA_SC_WIFI_WAIT_FOR_RESULT,
    RISHKA_SC_WIFI_SET_MINSEC,
    RISHKA_SC_WIFI_SET_SCAN_METHOD,
    RISHKA_SC_WIFI_SET_SORT_METHOD,
    RISHKA_SC_WIFI_STATUS,
    RISHKA_SC_WIFI_SSID,
    RISHKA_SC_WIFI_PSK,
    RISHKA_SC_WIFI_BSSID,
    RISHKA_SC_WIFI_SET_LOCAL_IP,
    RISHKA_SC_WIFI_GET_LOCAL_IP,
    RISHKA_SC_WIFI_SET_GATEWAY_IP,
    RISHKA_SC_WIFI_GET_GATEWAY_IP,
    RISHKA_SC_WIFI_SET_SUBNET_MASK,
    RISHKA_SC_WIFI_GET_SUBNET_MASK,
    RISHKA_SC_WIFI_SET_DNS_IP,
    RISHKA_SC_WIFI_GET_DNS_IP,
    RISHKA_SC_WIFI_MAC_ADDR,
    RISHKA_SC_WIFI_BROADCAST_IP,
    RISHKA_SC_WIFI_NETWORK_ID,
    RISHKA_SC_WIFI_ENABLE_IPV6,
    RISHKA_SC_WIFI_LINK_LOCAL_IPV6,
    RISHKA_SC_WIFI_GLOBAL_IPV6,
